...
##   $ docker build -t paharry-travian-world .
##
## RUNNING
##   $ docker run -p 9000:9000 paharry-travian-world
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="a8qplvs" \
    STACKSMITH_STACK_NAME="paharry/travian-world" \
